# -*- coding: utf-8 -*-
#
# GeoMop Source Documentation documentation build configuration file, created by
...
if sys.argv[4] == 'LE':
  ...
  # The master toctree document.
  master_doc = 'index'
  project = u'GeoMop Documentation'
...
htmlhelp_basename = 'GeoMopSourceDocumentationdoc'
...
latex_documents = [
  ('index', 'GeoMopSourceDocumentation.tex', u'GeoMop Source Documentation',
   u'TUL', 'manual'),
]
...
man_pages = [
    ('index', 'geomopsourcedocumentation', u'GeoMop Source Documentation',
     [u'TUL'], 1)
]
...
texinfo_documents = [
  ('index', 'GeoMopSourceDocumentation', u'GeoMop Source Documentation',
   u'TUL', 'GeoMopSourceDocumentation', 'One line description of project.',
   'Miscellaneous'),
]
