...
class TranformationDetailDlg(QtWidgets.QDialog):
    ...
    def __init__(self, name, description, v1,  orig_v1, v2, is_v2 , parent=None):
        ...
        buttonBox.addButton(self._tranform_button, QtWidgets.QDialogButtonBox.AcceptRole)
        buttonBox.addButton(self._cancel_button, QtWidgets.QDialogButtonBox.RejectRole)

        grid.addWidget(buttonBox, new_line, 1)
        self.setLayout(grid)
