...
class JsonEditorDlg(QtWidgets.QDialog):
    ...
    def __init__(self, path, name, label_name, json, parent=None):
        ...
        buttonLayout.addWidget(self._label_file)
        buttonLayout.addWidget(self._save_button)
        buttonLayout.addWidget(self._save_as_button)
        buttonLayout.addWidget(self._cancel_button)
